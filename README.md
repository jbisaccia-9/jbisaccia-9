...
|---|---|---|
| [gorilla-protocol](https://github.com/jbisaccia-9/gorilla-protocol) · **[PLAY UE5 CLOUD BUILD](https://35-252-252-152.sslip.io/)** | a deployed Unreal Engine 5.8 Linux FPS streamed from an L4 GPU, with coordinated tactical AI, first-person combat, objectives, extraction, Italian dialogue, and the complete Java and WebGL historical iterations preserved in the same repo; the guarded host sleeps when idle | an original gorilla secret agent with modern espionage gameplay and a deliberately silly banana obsession |
